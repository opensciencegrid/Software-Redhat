...
if [ "$1" = "1" ]; then
    # If this is an upgrade, restart the service
    /sbin/service bwctld restart
fi
...
%changelog
* Thu Sep 30 2010 Aaron Brown <aaron@internet2.edu> - 1.3-5
- Add a server dependency on various tools used by the %post script
