...
Patch0:         Create-PID-file-directory-var-run-myproxy-server-on-.patch
...
%changelog
* Wed Oct 14 2015 Mátyás Selmeci <matyas@cs.wisc.edu> 6.1.12-1.1.osg
- Have systemd service file create pidfile directory /var/run/myproxy-server
  (SOFTWARE-2071)
