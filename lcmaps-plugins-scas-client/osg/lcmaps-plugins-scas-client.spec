...
Patch0: ssl-ctx-memory-leak.patch
# xacml 1.5.0 is preferred for the new API and `issuer' fix
BuildRequires: lcmaps-devel, openssl-devel, xacml-devel >= 1.5.0-1
Requires: lcmaps%{?_isa} >= 1.5.0-1
Requires: xacml%{?_isa} >= 1.5.0-1
...
%changelog
* Tue Nov 11 2015 Dave Dykstra <dwd@fnal.gov> 0.5.5-1.1
- Add patch from Mischa for memory leak.

* Mon Jul 13 2015 Mischa Salle <msalle@nikhef.nl> 0.5.5-1
- updated version

* Fri Nov 28 2014 Mischa Salle <msalle@nikhef.nl> 0.5.4-1
- updated minimal XACML version
- updated version
