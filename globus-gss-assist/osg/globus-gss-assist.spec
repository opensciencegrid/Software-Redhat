...
Patch0:         RIC-239-gss-assist-openssl-1.0.1.patch
...
%changelog
* Wed Dec 11 2013 Matyas Selmeci <matyas@cs.wisc.edu> - 8.1-4.1.osg
- Add patch for RIC-239 (an OpenSSL 1.0.1 incompatibility)
