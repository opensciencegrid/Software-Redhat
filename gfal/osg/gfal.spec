...
./configure --with-glite-location=/usr --with-globus-nothr-flavor=gcc64dbg --with-globus-thr-flavor=gcc64dbgpthr --with-gsoap-location=/usr --with-gsoap-version=2.7.13 --with-cgsi-gsoap-location=/usr --prefix=$RPM_BUILD_ROOT/usr --with-lfc-location=/usr --with-version=%{version} --with-release=%{release}
...
%changelog
* Fri Jul 08 2011 Derek Weitzel <dweitzel@cs.eunl.edu> 1.11.14-3
