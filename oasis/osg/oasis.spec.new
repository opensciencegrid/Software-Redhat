...
%if  %{?rhel}%{!?rhel:0} > 5
echo %{pythonsitelib}/oasis-2.0.38-py2.6.egg-info >> INSTALLED_FILES_REPLICA
%endif
echo %{pythonsitelib}/oasispackage/oasisreplicaAPI.pyc >> INSTALLED_FILES_REPLICA
echo %{pythonsitelib}/oasispackage/oasisreplicaAPI.py >> INSTALLED_FILES_REPLICA
echo %{pythonsitelib}/oasispackage/oasisreplicaAPI.pyo >> INSTALLED_FILES_REPLICA
