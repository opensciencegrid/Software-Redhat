...
Requires: cvmfs = 2.7.4
Requires: cvmfs-config-osg = 2.4-4%{?dist}
Requires: cvmfs-x509-helper >= 2.1
...
%changelog
* Wed Sep 09 2020 Dave Dykstra <dwd@fnal.gov> 16-5
- Update to cvmfs-2.7.4

* Wed Jun 24 2020 Dave Dykstra <dwd@fnal.gov> 16-4
