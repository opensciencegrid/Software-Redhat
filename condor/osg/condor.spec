...
Patch0: sw2816-collector-python-fix.patch 
#% if 0%osg
...
%changelog
* Wed Jul 12 2017 Brian Lin <blin@cs.wisc.edu> - 8.6.4-1.1
- Fix undefined symbols in collector Python plugin (SOFTWARE-2816)
