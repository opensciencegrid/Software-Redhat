...
# Required for functionality with HTCondor-CE 3.0.0
# https://jira.opensciencegrid.org/browse/SOFTWARE-2845
Patch0: sw2845_collector_plugin.patch 
#% if 0%osg
