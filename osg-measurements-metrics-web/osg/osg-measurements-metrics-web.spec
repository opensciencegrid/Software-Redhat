%define name osg-measurements-metrics-web
%define version 1.1
%define unmangled_version 1.1
%define release 3

Summary: OSG Measurements and Metrics webpages.
Name: %{name}
Version: %{version}
Release: %{release}
...
Requires: graphtool >= 0.6.4 MySQL-python python-sqlite python-cheetah /usr/bin/ldapsearch python-cherrypy >= 3.1.2 python-ZSI python-setuptools osg-measurements-metrics-db python-json gratia-probe-common gratia-probe-services
Obsoletes: OSG-Measurements-Metrics-Web
