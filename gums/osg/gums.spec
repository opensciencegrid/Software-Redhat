...
%triggerpostun service -- gums-service < 1.5.2-12
...
%changelog
* Tue Oct 31 2017 Carl Edquist <edquist@cs.wisc.edu> - 1.5.2-13
...
* Wed Aug 17 2016 Carl Edquist <edquist@cs.wisc.edu> - 1.5.2-7
- Add JSON interface for getOsgUserVoMap (SOFTWARE-2380)
