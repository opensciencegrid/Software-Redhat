...
%global upstream_version 1.4.0-pre1
License: Unknown
...
# svn export https://svn.usatlas.bnl.gov/svn/privilege/tags/gums-core-1.4.0-pre1 gums-core
# tar zcf gums-core-1.4.0-pre1.tar.gz gums-core/
Source0: %{name}-core-%{upstream_version}.tar.gz
# svn export https://svn.usatlas.bnl.gov/svn/privilege/tags/gums-client-1.4.0-pre1 gums-client
# tar zcf gums-client-1.4.0-pre1.tar.gz gums-client
Source1: %{name}-client-%{upstream_version}.tar.gz
# svn export https://svn.usatlas.bnl.gov/svn/privilege/tags/gums-service-1.4.0-pre1 gums-service
# tar zcf gums-service-1.4.0-pre1.tar.gz gums-service/
Source2: %{name}-service-%{upstream_version}.tar.gz
...
- Version bump to upstream 1.4.0-pre1
