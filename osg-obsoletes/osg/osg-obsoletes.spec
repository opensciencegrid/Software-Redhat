...
Obsoletes: gfal2 <= 2.18.1
Obsoletes: gfal2-all <= 2.18.1
Obsoletes: gfal2-debuginfo <= 2.18.1
Obsoletes: gfal2-devel <= 2.18.1
Obsoletes: gfal2-doc <= 2.18.1
Obsoletes: gfal2-plugin-dcap <= 2.18.1
Obsoletes: gfal2-plugin-file <= 2.18.1
Obsoletes: gfal2-plugin-gridftp <= 2.18.1
Obsoletes: gfal2-plugin-http <= 2.18.1
Obsoletes: gfal2-plugin-lfc <= 2.18.1
Obsoletes: gfal2-plugin-mock <= 2.18.1
Obsoletes: gfal2-plugin-rfio <= 2.18.1
Obsoletes: gfal2-plugin-sftp <= 2.18.1
Obsoletes: gfal2-plugin-srm <= 2.18.1
Obsoletes: gfal2-plugin-xrootd <= 2.18.1
...
Obsoletes: globus-gridftp-server <= 13.20
Obsoletes: globus-gridftp-server-debuginfo <= 13.20
Obsoletes: globus-gridftp-server-devel <= 13.20
Obsoletes: globus-gridftp-server-progs <= 13.20
...
Obsoletes: gsi-openssh <= 7.4p1
Obsoletes: gsi-openssh-clients <= 7.4p1
Obsoletes: gsi-openssh-debuginfo <= 7.4p1
Obsoletes: gsi-openssh-server <= 7.4p1
...
Obsoletes: myproxy <= 6.2.6
Obsoletes: myproxy-admin <= 6.2.6
Obsoletes: myproxy-debuginfo <= 6.2.6
Obsoletes: myproxy-devel <= 6.2.6
Obsoletes: myproxy-doc <= 6.2.6
Obsoletes: myproxy-libs <= 6.2.6
Obsoletes: myproxy-server <= 6.2.6
Obsoletes: myproxy-voms <= 6.2.6
...
Obsoletes: xrootd <= 1:4.12.6
Obsoletes: xrootd-client <= 1:4.12.6
Obsoletes: xrootd-client-devel <= 1:4.12.6
Obsoletes: xrootd-client-libs <= 1:4.12.6
Obsoletes: xrootd-debuginfo <= 1:4.12.6
Obsoletes: xrootd-devel <= 1:4.12.6
Obsoletes: xrootd-doc <= 1:4.12.6
Obsoletes: xrootd-fuse <= 1:4.12.6
...
Obsoletes: xrootd-libs <= 1:4.12.6
Obsoletes: xrootd-multiuser <= 0.4.3
Obsoletes: xrootd-multiuser-debuginfo <= 0.4.3
Obsoletes: xrootd-private-devel <= 1:4.12.6
Obsoletes: xrootd-scitokens <= 1.2.2
Obsoletes: xrootd-scitokens-debuginfo <= 1.2.2
Obsoletes: xrootd-selinux <= 1:4.12.6
Obsoletes: xrootd-server <= 1:4.12.6
Obsoletes: xrootd-server-devel <= 1:4.12.6
Obsoletes: xrootd-server-libs <= 1:4.12.6
Obsoletes: xrootd-voms <= 1:4.12.6
...
Obsoletes: lcmaps-without-gsi-devel <= 1.6.6
Obsoletes: voms <= 2.1.0
Obsoletes: voms-clients-cpp <= 2.1.0
Obsoletes: voms-clients-cpp-debuginfo <= 2.1.0
Obsoletes: voms-debuginfo <= 2.1.0
Obsoletes: voms-debugsource <= 2.1.0
Obsoletes: voms-devel <= 2.1.0
Obsoletes: voms-doc <= 2.1.0
Obsoletes: voms-server <= 2.1.0
