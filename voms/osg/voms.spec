...
%package clients
Summary:	Virtual Organization Membership Service (transitional dummy package)
Group:		Applications/Internet
Requires:	%{name}-clients-cpp

%description clients
This is a transitional package for the rename from voms-clients to
voms-clients-cpp.  It may safely be removed at any time.
...
%changelog
* Mon Apr 06 2015 Mátyás Selmeci <matyas@cs.wisc.edu> 2.0.12-3.1.osg
- Add dummy voms-clients package (SOFTWARE-1866)
