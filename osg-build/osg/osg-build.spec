...
Patch0:         Fix-type-error-when-detecting-redhat-release-and-det.patch
...
%changelog
* Tue Jun 30 2020 Mátyás Selmeci <matyas@cs.wisc.edu> - 1.16.1-2
- Add patch to fix type error when detecting redhat release for mock builds
  Fix-type-error-when-detecting-redhat-release-and-det.patch
