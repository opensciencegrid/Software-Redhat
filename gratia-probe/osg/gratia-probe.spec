...
%changelog
* Tue Oct 07 2014 Mátyás Selmeci <matyas@cs.wisc.edu> 1.13.30-4
- Remove ifarch/ifnarch lines because they were silently keeping most probes
  from building on el7.  A side effect is that all of the probes will be in
