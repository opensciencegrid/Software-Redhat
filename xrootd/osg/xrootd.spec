# OSG additions
# "bcond_without" enables something by default, "bcond_with" disables it by default
...
#-------------------------------------------------------------------------------
%changelog
* Thu May 15 2025 Mátyás Selmeci <mselmeci@wisc.edu> - 5.8.2-1.4
- Merged spec file modernization from upstream (SOFTWARE-6073)
